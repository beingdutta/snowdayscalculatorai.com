    ...
    <main class="blog-wrapper">
        ...
        <section class="blog-list">
            ...
            <a class="blog-card" href="/blogs/what-is-a-snow-day">
                <div class="blog-card-image" style="background-image: url('https://images.unsplash.com/photo-1547754980-3df97fed72a8?q=80&w=2070')"></div>
            ...
            <a class="blog-card" href="/blogs/what-makes-a-snow-day">
                <div class="blog-card-image" style="background-image: url('https://images.unsplash.com/photo-1612203389915-8c3f1a7c5846?q=80&w=1974')"></div>
                <div class="blog-card-content">
            ...
            <a class="blog-card" href="/blogs/how-snow-day-calculator-works">
                <div class="blog-card-image" style="background-image: url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070')"></div>
                <div class="blog-card-content">
            ...
            <a class="blog-card" href="/blogs/how-much-snow-for-a-snow-day">
                <div class="blog-card-image" style="background-image: url('https://images.unsplash.com/photo-1516553174826-d05833723cd4?q=80&w=2070')"></div>
                <div class="blog-card-content">
            ...
            <a class="blog-card" href="/blogs/how-much-snow-does-it-take-to-cancel-school">
                <div class="blog-card-image" style="background-image: url('https://images.unsplash.com/photo-1580372821966-5153bf52a739?q=80&w=1974')"></div>
                <div class="blog-card-content">
            ...
            <a class="blog-card" href="/blogs/How-many-snow-days-do-schools-get">
                <div class="blog-card-image" style="background-image: url('https://images.unsplash.com/photo-1579492473779-518544243f6a?q=80&w=1964')"></div>
                <div class="blog-card-content">
